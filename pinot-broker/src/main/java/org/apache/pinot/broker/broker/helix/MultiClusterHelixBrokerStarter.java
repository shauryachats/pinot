...
import org.apache.pinot.broker.routing.MultiClusterRoutingManager;
import org.apache.pinot.broker.routing.RemoteClusterBrokerRoutingManager;
...
public class MultiClusterHelixBrokerStarter extends BaseBrokerStarter {
  ...
  protected MultiClusterRoutingManager _federatedRoutingManager;
  protected MultiClusterRoutingContext _crossClusterFederationProvider;
  ...
  private void initRemoteClusterFederatedRoutingManager() {
    ...
    if (_remoteRoutingManagers.isEmpty()) {
      ...
      _federatedRoutingManager = new MultiClusterRoutingManager(_routingManager,
  ...
  private void initRemoteClusterFederationProvider(TableCache primaryTableCache, boolean caseInsensitive) {
    if (_federatedRoutingManager == null) {
    ...
    _crossClusterFederationProvider = new MultiClusterRoutingContext(tableCacheMap, _routingManager,
        _federatedRoutingManager);
