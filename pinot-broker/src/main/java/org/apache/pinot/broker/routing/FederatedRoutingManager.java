...
//    // Build routing in primary routing manager
//    _primaryRoutingManager.buildRouting(tableNameWithType);
//
//    // Build routing in all secondary routing managers
//    for (BrokerRoutingManager secondaryRoutingManager : _secondaryRoutingManagers) {
//      try {
//        secondaryRoutingManager.buildRouting(tableNameWithType);
//      } catch (Exception e) {
//        LOGGER.error("Error building routing for table {} in secondary routing manager", tableNameWithType, e);
//      }
//    }
//
//    // Clear routing table cache for this table
//    _combinedRoutingTableCache.remove(tableNameWithType);
//  }
//
//  @Override
//  public void removeRouting(String tableNameWithType) {
//    // Remove routing from primary routing manager
//    _primaryRoutingManager.removeRouting(tableNameWithType);
//
//    // Remove routing from all secondary routing managers
//    for (BrokerRoutingManager secondaryRoutingManager : _secondaryRoutingManagers) {
//      try {
//        secondaryRoutingManager.removeRouting(tableNameWithType);
//      } catch (Exception e) {
//        LOGGER.error("Error removing routing for table {} in secondary routing manager", tableNameWithType, e);
//      }
//    }
//
//    // Remove from cache
...
//    // Refresh segment in primary routing manager
//    _primaryRoutingManager.refreshSegment(tableNameWithType, segment);
//
//    // Refresh segment in all secondary routing managers
//    for (BrokerRoutingManager secondaryRoutingManager : _secondaryRoutingManagers) {
//      try {
...
//  }
  ...
  private RoutingTable combineRoutingTables(RoutingTable primaryRoutingTable, String tableNameWithType,
    ...
    Map<ServerInstance, ServerRouteInfo> combinedServerInstanceToSegmentsMap =
      ...
      try {
        ...
        if (secondaryRoutingTable != null) {
          ...
          for (Map.Entry<ServerInstance, ServerRouteInfo> entry : secondaryRoutingTable.getServerInstanceToSegmentsMap().entrySet()) {
            ...
            ServerRouteInfo existingRouteInfo = combinedServerInstanceToSegmentsMap.get(serverInstance);
