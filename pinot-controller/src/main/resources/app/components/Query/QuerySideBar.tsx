...
type Props = {
  ...
  onQueryTypeChange?: (type: 'regular' | 'timeseries') => void;
};

const Sidebar = ({ tableList, fetchSQLData, tableSchema, selectedTable, queryLoader, queryType, onQueryTypeChange }: Props) => {
      ...
      >
        <div className={classes.drawerContainer}>
          <Grid item xs className={classes.leftPanel}>
            ...
            {/* Show tables for both regular and timeseries queries */}
            <CustomizedTables
              title="Tables"
              data={tableList}
